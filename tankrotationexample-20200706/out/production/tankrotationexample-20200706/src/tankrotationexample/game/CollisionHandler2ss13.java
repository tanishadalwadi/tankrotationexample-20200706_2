...
public class CollisionHandler2ss13 {
    ...
    public CollisionHandler2ss13(ArrayList<GameObject> objects) {
    ...
    public void checkForCollision() {
        ...
        System.out.println("T1 DETAIL bfr for loop  "+t1Box);
        System.out.println("T2 DETAIL bfr for loop   "+t2Box);
