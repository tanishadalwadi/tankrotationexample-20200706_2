...
public class TRE extends JPanel implements Runnable {
    ...
    public static int t1life = 3;
    public static int t2life = 3;
    ...
    public void run() {
        try {
            ...
            while (t1life>0 && t2life>0) {
                ...
                collisionhandler = new CollisionHandler(activeobjects);
                ...
                for (int curCol = 0; curCol < numCols; curCol++) {
                    switch (mapInfo[curCol]) {
                        ...
                        case "9":
                            ...
                            break;
                        case "5":
                            HealthPowerUp hpu = new HealthPowerUp(curCol * 32, curRow * 32, true, healthpowerup);
                            this.objects.add(hpu);
    ...
    public void paintComponent(Graphics g) {
       ...
       // System.out.println("T2 details " + t2Xvalue + " " + t2Yvalue);
        ...
        g2.fillRect(GameConstants.GAME_SCREEN_WIDTH / 2 + 25, 40, 2 * t2.getHealth2(), 20);
        if (t1life == 0) {
            if (t1.getHealth1() <= 0) {
                System.out.println("T1 HEALTH --->> " + t1.getHealth2() + " " + t1life);
                g2.drawString("Player1 lives: " + t1life, GameConstants.GAME_SCREEN_WIDTH / 2 + 10, 28);
                g2.drawString("[", GameConstants.GAME_SCREEN_WIDTH / 2 + 10, 58);
                g2.drawString("]", GameConstants.GAME_SCREEN_WIDTH / 2 + 222, 58);
                g2.fillRect(GameConstants.GAME_SCREEN_WIDTH / 2 + 25, 40, 2 * t1.getHealth2(), 20);
                g2.setColor(Color.green);
            }
            this.winner = "Player2";
            lf.setFrame("end");
        ...
        if (t2life == 0) {
            if (t2.getHealth1() <= 0) {
                System.out.println("T2 HEALTH --->> " + t2.getHealth2() + " " + t2life);
                g2.drawString("Player2 lives: " + t2life, GameConstants.GAME_SCREEN_WIDTH / 2 + 10, 28);
                g2.drawString("[", GameConstants.GAME_SCREEN_WIDTH / 2 + 10, 58);
                g2.drawString("]", GameConstants.GAME_SCREEN_WIDTH / 2 + 222, 58);
                g2.fillRect(GameConstants.GAME_SCREEN_WIDTH / 2 + 25, 40, 2 * t2.getHealth2(), 20);
