...
public class Launcher {
     ...
     */
    private JFrame jf;
    /* Container for a bunch of j components
    ...
    //Allows us to rotate or switch sub panels
    static JLabel l;
...
//Sets up jframe in the main panel
    private void initUIComponents(){
        ...
        cl = new CardLayout(); // creating a new CardLayout Panel (To rotate between start,end,main)
        ...
        switch(type){
            ...
            case "game":
               ...
               // this.jf.setSize(GameConstants.GAME_SCREEN_WIDTH,GameConstants.GAME_SCREEN_HEIGHT);
                ...
                (new Thread(this.gamePanel)).start(); //Make a new thread obj..
                // Run tank game in a diff UI thread, where the GUI runs on
                break;
            case "end":
                this.jf.setSize(GameConstants.END_MENU_SCREEN_WIDTH,GameConstants.END_MENU_SCREEN_HEIGHT);
                System.out.println(this.gamePanel.winner);
                this.endPanel = new EndGamePanel(this, this.gamePanel.winner); // create a new end game pane;
